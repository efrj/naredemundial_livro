                        ...
                        <td bgcolor=white>
                            <table width="100%" border="0" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><input name="ENDERECO" type=text id="ENDERECO" value="" size=30 maxlength="100"></td>
                                </tr>
                                <tr>
                                    <td><b>Fone</b>: </td>
                                    <td><input name="DDD" type=text id="DDD" value="" size=3 maxlength="3"> - <input name="FONE" type=text id="FONE" value="" size=7 maxlength="10"></td>
                                </tr>
                                <tr>
                                    <td><b>Email</b>: </td>
