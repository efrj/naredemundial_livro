...
function listar_agenda()
{
    global $con;
    $valor = "";
    $sql = "SELECT ID, NOME, ENDERECO, DDD, FONE, EMAIL,
                 OBSERVACOES, DATA FROM Agenda";
    ...
    if (!$result) {
        ...
        while (odbc_fetch_row($result)) {
            $valor .= "<tr>
                <td class=\"default\">
                <a href=\"editar.php?ID=" . odbc_result($result, 1) . "\">Editar</a>
                </td>
                <td class=\"default\">
                <a href=\"#\" onClick=\"window.open('detalhes.php?ID=" .
                odbc_result($result, 1) .
                "','Detalhes','width=350,height=200')\">" .
                odbc_result($result, 2) . "</a>
</td>

<td class=\"default\"><a href=\"#\"
onClick=\"window.open('detalhes.php?ID=" . odbc_result(
                $result,
                1
            ) . "','Detalhes','width=350,height=200')\">" . odbc_result(
                $result,
                6
            ) . "</a></td>
...
<td class=\"default\"><a href=\"#\"
onClick=\"window.open('excluir.php?ID=" . odbc_result(
                $result,
                1
...
if (
    ...
    if (empty($con)) { //Testa se existe conexão
