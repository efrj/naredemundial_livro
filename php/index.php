                  ...
                  <tr>
                        <td bgcolor=white>
                              <table width="100%" border="0" align="center">
                                    <tr>
                                          <td align=right colspan=2>.: <b>Bem Vindo. Por favor informe seus dados</b> :.
                                          </td>
                                    </tr>
                                    <tr>
                                          <td align=right width="30%"><b>Login</b>: &nbsp;</td>
                                          <td><input name="LOGIN" type=text id="LOGIN" style="width:80px;" value=""
                                                      size=5></td>
                                    </tr>
                                    <tr>
                                    </tr>
                                    <td align=right width="30%"><b>Senha</b>: &nbsp;</td>
                                    <td><input name="SENHA" type=password id="SENHA" style="width:80px;" value=""
                                                size=5></td>
                  </tr>
                  <tr>
                        <td>&nbsp;</td>
